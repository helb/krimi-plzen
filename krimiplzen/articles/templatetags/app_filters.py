...
def insert_photo_thumbs(content):
    ...
    for url in urls:
        ...
        thumb_webp = get_thumbnail(
            ssl_url, "200x200", crop="center", format="WEBP", quality=95)
  ...
  <source type="image/webp" srcset='{thumb_webp.url} 200w' />
  <source type="image/jpeg" srcset='{thumb_l.url} 200w' />
  <img src='{thumb_l.url}'></picture></a>""", content, re.IGNORECASE)
...
def insert_article_links(content):
    link_regex = r"(<hr data-href=\"[a-z0-9-]+\" contenteditable=\"false\" class=\"editor-article-link\">|<hr data-href=\"[a-z0-9-]+\" class=\"editor-article-link\" contenteditable=\"false\">)"
    ...
    for link in links:
        ...
        link_with_slug = r"(<hr data-href=\"" + slug + "\" contenteditable=\"false\" class=\"editor-article-link\">|<hr data-href=\"" + slug + "\" class=\"editor-article-link\" contenteditable=\"false\">)"
