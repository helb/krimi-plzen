...
Router.map(function() {
    this.route("newArticles", {
        ...
        waitOn: function() {
            if (Meteor.isClient) {
                ...
                return listSubs.subscribe("newArticles", Session.get("currentLimit")) && listSubs.subscribe("partnerList");
            } else {
                return;
            }
        },
    ...
    this.route("articleShow", {
        ...
        cache:  true,
        waitOn: function() {
            return articleSubs.subscribe("article", this.params.slug) && listSubs.subscribe("partnerArticles");
        },
        data: function() {
            var templateData = {
        ...
        onAfterAction: function() {
            ...
            if (typeof article != "undefined") {
                if (typeof article.photo_url != "undefined") {
                    ...
                    photo_url = "//farm4.staticflickr.com/3921/15159532768_129e15feb2_o.jpg";
                }
                ...
                Meta.set("og:image", "https:" + article.photo_url.replace("_q", "_b"));
