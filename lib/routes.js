...
Router.map(function() {
    this.route("newArticles", {
        ...
        onAfterAction: function() {
            if (!Meteor.isClient) {
                ...
                return Meta.set("og:title", "Krimi Plzeň");
            }
        }
    });
    ...
    this.route("minimumUliceArticles", {
        ...
        onAfterAction: function() {
            ...
            Meta.set("viewport", "width=device-width, initial-scale=1.0")
            return Meta.setTitle("Právní minimum ulice");
                // GAnalytics.pageview();
        }
    });
    ...
    this.route("zachranariArticles", {
        ...
        onAfterAction: function() {
            ...
            Meta.set("viewport", "width=device-width, initial-scale=1.0")
            return Meta.setTitle("Záchranáři");
                // GAnalytics.pageview();
        }
    });
    ...
    this.route("mountainArticles", {
        ...
        onAfterAction: function() {
            ...
            Meta.set("viewport", "width=device-width, initial-scale=1.0")
            return Meta.setTitle("Horská služba");
                // GAnalytics.pageview();
        }
    });
